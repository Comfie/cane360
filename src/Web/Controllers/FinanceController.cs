...
public sealed class FinanceController(IFinanceService finance) : ControllerBase
{
    ...
    {
        return Ok(await finance.GetSessionAsync(cancellationToken));
    }
    ...
    {
        return Ok(await finance.GetTransactionAsync(transactionId,
            cancellationToken));
    }
    ...
    public async Task<ActionResult<OperationalTransactionDto>> SetAllocations(Guid transactionId,
        SetTransactionAllocationsRequest request, CancellationToken cancellationToken)
    {
        return Ok(await
            finance.SetAllocationsAsync(transactionId, new SetTransactionAllocationsInput(request.ExpectedVersion,
    ...
    public async Task<ActionResult<OperationalTransactionDto>> PostTransaction(Guid transactionId,
        PostOperationalTransactionRequest request, CancellationToken cancellationToken)
    {
        return Ok(await
            finance.PostAsync(transactionId, new PostOperationalTransactionInput(request.ExpectedVersion,
    ...
    public async Task<ActionResult<OperationalTransactionDto>> ReverseTransaction(Guid transactionId,
        ReverseOperationalTransactionRequest request, CancellationToken cancellationToken)
    {
        return Ok(await
            finance.ReverseAsync(transactionId,
                new ReverseOperationalTransactionInput(request.Reason, request.IdempotencyKey), cancellationToken));
    }
    ...
    public async Task<ActionResult<CropCycleCostSummaryDto>> GetCropCycleCost(Guid cropCycleId,
        CancellationToken cancellationToken)
    {
        return Ok(await finance.GetCropCycleCostAsync(cropCycleId,
            cancellationToken));
    }
    ...
    public async Task<ActionResult<PayrollCostReconciliationDto>> ReconcilePayrollCosts(
        CancellationToken cancellationToken)
    {
        return Ok(await finance.ReconcilePayrollAsync(cancellationToken));
    }
    ...
    public async Task<ActionResult<IReadOnlyList<BudgetDto>>> GetBudgets(Guid cropCycleId,
        CancellationToken cancellationToken)
    {
        return Ok(await finance.GetBudgetsAsync(cropCycleId,
            cancellationToken));
    }
    ...
    public async Task<ActionResult<BudgetDto>> GetBudget(Guid budgetId,
        CancellationToken cancellationToken)
    {
        return Ok(await finance.GetBudgetAsync(budgetId,
            cancellationToken));
    }
    ...
    public async Task<ActionResult<BudgetDto>> CreateBudget(CreateBudgetRequest request,
        CancellationToken cancellationToken)
    {
        BudgetDto result = await finance.CreateBudgetAsync(new CreateBudgetInput(request.CropCycleId, request.Name,
    ...
    public async Task<ActionResult<BudgetDto>> UpdateBudget(Guid budgetId,
        UpdateBudgetRequest request, CancellationToken cancellationToken)
    {
        return Ok(await
            finance.UpdateBudgetAsync(budgetId, new UpdateBudgetInput(request.Name, request.ReportingAreaHa,
    ...
    public async Task<ActionResult<BudgetDto>> AddBudgetLine(Guid budgetId,
        BudgetLineRequest request, CancellationToken cancellationToken)
    {
        return Ok(await
    ...
    public async Task<ActionResult<BudgetDto>> RemoveBudgetLine(Guid budgetId, Guid lineId,
        [FromQuery] long expectedRowVersion, CancellationToken cancellationToken)
    {
        return Ok(await
            finance.RemoveBudgetLineAsync(budgetId, lineId, new BudgetActionInput(expectedRowVersion),
                cancellationToken));
    }
    ...
    public async Task<ActionResult<BudgetDto>> SubmitBudget(Guid budgetId,
        BudgetActionRequest request, CancellationToken cancellationToken)
    {
        return Ok(await
            finance.SubmitBudgetAsync(budgetId, new BudgetActionInput(request.ExpectedRowVersion), cancellationToken));
    }
    ...
    public async Task<ActionResult<BudgetDto>> ApproveBudget(Guid budgetId,
        ApproveBudgetRequest request, CancellationToken cancellationToken)
    {
        return Ok(await
            finance.ApproveBudgetAsync(budgetId, new ApproveBudgetInput(request.ExpectedRowVersion,
    ...
    public async Task<ActionResult<BudgetDto>> CreateBudgetRevision(Guid budgetId,
        CreateBudgetRevisionRequest request, CancellationToken cancellationToken)
    {
        return Ok(await
            finance.CreateBudgetRevisionAsync(budgetId, new CreateBudgetRevisionInput(request.Name, request.Notes),
                cancellationToken));
    }
    ...
    public async Task<ActionResult<BudgetVarianceReportDto>> GetBudgetVariance(Guid cropCycleId,
        CancellationToken cancellationToken)
    {
        return Ok(await finance.GetBudgetVarianceAsync(cropCycleId,
            cancellationToken));
    }
    ...
    private static bool TryOptionalDate(string? value, out DateOnly? date)
    {
        ...
        if (!TransportValueParser.TryParseDateOnly(value, out DateOnly parsed))
        {
            return false;
        }
