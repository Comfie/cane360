...
public sealed class InputControlsController(ISender sender) : ControllerBase
{
    ...
    {
        return Ok(await sender.Send(new GetInputControlWorkspaceQuery(activityId), cancellationToken));
    }
    ...
    {
        return CreatedAtAction(nameof(Workspace), await sender.Send(new CreateInventoryApplicationRuleCommand(
    ...
    {
        return CreatedAtAction(nameof(Workspace), await sender.Send(new CreateInputRequestCommand(
    ...
    [HttpPost("requests/{requestId:guid}/submit", Name = "SubmitInputRequest")]
    ...
    [HttpPost("requests/{requestId:guid}/decision", Name = "DecideInputRequest")]
    ...
    {
        if (!Enum.TryParse<ApprovalOutcome>(request.Outcome, true, out ApprovalOutcome outcome))
        {
    ...
    [HttpPost("requests/{requestId:guid}/cancel", Name = "CancelInputRequest")]
    ...
    {
        return CreatedAtAction(nameof(Workspace), await sender.Send(new CreateStockIssueCommand(
    ...
    [HttpPost("issues/{issueId:guid}/post", Name = "PostStockIssue")]
    ...
    [HttpPost("issues/{issueId:guid}/reverse", Name = "ReverseStockIssue")]
    ...
    public async Task<ActionResult<Guid>> CreateFieldReceipt(CreateFieldReceiptRequest request,
        CancellationToken cancellationToken)
    {
        return CreatedAtAction(nameof(Workspace), await sender.Send(new CreateFieldReceiptCommand(request.StockIssueId,
    ...
    public async Task<ActionResult<Guid>> CreateApplication(CreateInputApplicationRequest request,
        CancellationToken cancellationToken)
    {
        return CreatedAtAction(nameof(Workspace), await sender.Send(new CreateInputApplicationCommand(
            request.ActivityId,
            request.AppliedAt, request.CoverageBasis, request.VerifiedCoverage, request.Lines.Select(x =>
                    new CreateInputApplicationLineCommand(x.FieldReceiptLineId, x.StockIssueLineId, x.AppliedQuantity))
                .ToArray()), cancellationToken));
    }

    [HttpPost("applications/{applicationId:guid}/attestation")]
    public async Task<IActionResult> AttestApplication(Guid applicationId, AttestInputApplicationRequest request,
        CancellationToken cancellationToken)
    {
        await sender.Send(
            new AttestInputApplicationCommand(applicationId, request.SupervisorPersonId, request.Note,
                request.ExpectedVersion), cancellationToken);
        return NoContent();
    }

    [HttpPost("applications/{applicationId:guid}/confirmation")]
    public async Task<IActionResult> ConfirmApplication(Guid applicationId, ConfirmInputApplicationRequest request,
        CancellationToken cancellationToken)
    {
        await sender.Send(
            new ConfirmInputApplicationCommand(applicationId, request.LateConfirmationReason, request.ExpectedVersion,
                request.IdempotencyKey), cancellationToken);
        return NoContent();
    }

    [HttpPost("returns")]
    public async Task<ActionResult<Guid>> CreateReturn(CreateStockReturnRequest request,
        CancellationToken cancellationToken)
    {
        return CreatedAtAction(nameof(Workspace), await sender.Send(new CreateStockReturnCommand(request.ActivityId,
    ...
    [HttpPost("returns/{stockReturnId:guid}/post", Name = "PostStockReturn")]
    public async Task<IActionResult> PostReturn(Guid stockReturnId, PostStockReturnRequest request,
        CancellationToken cancellationToken)
    {
        await sender.Send(new PostStockReturnCommand(stockReturnId, request.ExpectedVersion, request.IdempotencyKey),
            cancellationToken);
        return NoContent();
    }

    [HttpPost("returns/{stockReturnId:guid}/reverse", Name = "ReverseStockReturn")]
    public async Task<IActionResult> ReverseReturn(Guid stockReturnId, ReverseStockReturnRequest request,
        CancellationToken cancellationToken)
    {
    ...
    [HttpPost("losses")]
    public async Task<ActionResult<Guid>> CreateLoss(CreateInventoryLossRequest request,
        CancellationToken cancellationToken)
    {
        return CreatedAtAction(nameof(Workspace), await sender.Send(new CreateInventoryLossCommand(request.ActivityId,
            request.StockIssueLineId, request.Quantity, request.LossType, request.Reason), cancellationToken));
    }

    [HttpPost("losses/{lossId:guid}/submit", Name = "SubmitInventoryLoss")]
    public async Task<IActionResult> SubmitLoss(Guid lossId, VersionedInventoryRequest request,
        CancellationToken cancellationToken)
    {
    ...
    [HttpPost("losses/{lossId:guid}/decision", Name = "DecideInventoryLoss")]
    public async Task<IActionResult> DecideLoss(Guid lossId, DecideInventoryLossRequest request,
        CancellationToken cancellationToken)
    {
    ...
    {
        return CreatedAtAction(nameof(Workspace), await sender.Send(new CreateFieldAccountabilityCorrectionCommand(
    ...
    [HttpPost("corrections/{correctionId:guid}/decision", Name = "DecideFieldAccountabilityCorrection")]
    ...
    {
        return Ok(await sender.Send(new CreateManagerInvitationCommand(
    ...
    {
        return Ok(await sender.Send(new RedeemManagerInvitationCommand(request.Token), cancellationToken));
    }
}
