...
import { cycleGroup, filterCycles, flattenCycleCollections, formatCycleStatus } from './cropCycleView.js';
...
test('cycle filter does not treat harvested as closed history', () => {
  const cycles = /** @type {import('../../web-api-client').CropCycleListItemDto[]} */ ([
...
test('field collections flatten into reverse chronological order', () => {
  const collections = /** @type {import('../../web-api-client').CropCycleCollectionDto[]} */ ([
    {
      field: { id: 'field-a' },
      cropCycles: [
